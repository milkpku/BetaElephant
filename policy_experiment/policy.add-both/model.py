...
def get_model(name):
    ...
    x = tf.concat(3, [self_pos, enemy_pos, self_ability, enemy_ability, enemy_protect], name=name('input_concat'))
    y = input_label
    ...
    return Model([self_pos, enemy_pos, self_ability, enemy_ability, enemy_protect], input_label, loss, pred, debug=z)
